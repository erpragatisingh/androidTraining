package com.example.custommusic;
    ...
    public void onPause(){
        ...
        if(track != null){
            if(track.isPlaying()){
                track.pause();
                isTuning = false;
                btnPlay.setBackgroundResource(R.drawable.ic_launcher);
            }
            if(isFinishing()){
                track.dispose();
                finish();
  ...
  //loads a Music instance using either a built in asset or an external resource
    ...
    private void createMenu(Menu menu){
        MenuItem miLooping = menu.add(0, 0, 0, "Looping");{
            miLooping.setIcon(R.drawable.ic_action_search);
        }
        MenuItem miShuffle = menu.add(0, 1, 1, "Shuffle");{
            miShuffle.setIcon(R.drawable.ic_action_search);
        }
        MenuItem miStop = menu.add(0, 2, 2, "Stop");{
            miStop.setIcon(R.drawable.ic_action_search);
        }
        MenuItem miSource = menu.add(0, 3, 3, "Source");{
            miSource.setIcon(R.drawable.ic_action_search);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        case 2:
            ...
            synchronized(this){
                track.switchTracks();
                btnPlay.setBackgroundResource(R.drawable.ic_action_search);
            }
            return true;
        case 3:
