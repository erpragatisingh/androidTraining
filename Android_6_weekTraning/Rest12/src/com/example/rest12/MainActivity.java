...
public class MainActivity extends Activity {
    ...
    private static final String SERVICE_URL = "http://api.geonames.org/postalCodeSearchJSON?formatted=true&postalcode=9791&maxRows=10&username=demo&style=full";
    ...
    public void clearControls(View vw) {
        ...
        EditText edFirstName = (EditText) findViewById(R.id.editText1);
        EditText edLastName = (EditText) findViewById(R.id.editText2);
